...
subroutine ispis3(I1,I2,I3,Ir,Is,It,Iro,Iso,Ito,Iz,DV,DV2,Pr,Ps,Pt,Puc,Por,Pos,Pot,Pus,Puk)
	implicit none

	complex(8),intent(in) :: Ir,Is,It,Iro,Iso,Ito,Iz,I1,I2,I3,DV,DV2
	...
	write(2,'(/,"Razlika napona zvjezdista (oklop):")')
	write(2,'("---------------------------------------")')
	call zmk(DV2,Modul,Kut)
	write(2,'("DV2 =",f10.3," (V) /",f6.1," (o)")') Modul,Kut
	...
	write(*,'(/,"Razlika napona zvjezdista (oklop):")')
	write(*,'("---------------------------------------")')
	call zmk(DV2,Modul,Kut)
	write(*,'("DV2 =",f10.3," (V) /",f6.1," (o)")') Modul,Kut
